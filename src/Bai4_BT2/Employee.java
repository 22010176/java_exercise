...
public class Employee {
    ...
    public void in() {
        System.out.printf("ten nhan vien: %s %s, ngay sinh: %s, luong: %.2f", ho, ten, ngaySinh, luong);
    }

    public String toString() {
        return String.format("id: %d, ten nhan vien: %s %s, ngay sinh: %s, luong: %.2f, so nam cong tac: %d", id, ho,
                ten,
